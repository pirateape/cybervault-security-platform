...
// CyberVault SignupForm Component - Updated Design System

import { useState } from 'react';
import { useSearchParams } from 'next/navigation';
import { signup, signInWithGoogle, signInWithGitHub, signInWithAzure } from '../../auth/actions';
...
export default function SignupForm() {
  ...
  const styles = {
    ...
    successMessage: {
      backgroundColor: 'rgba(var(--color-success-rgb), var(--status-bg-opacity))',
      ...
      <div className="card" style={styles.card}>
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            Create your account to get started with enterprise security
          </p>
        </div>
        ...
        <div style={styles.footer}>
          ...
          <a href="/auth/login" style={styles.footerLink}>
            Sign in
          </a>
        </div>
      </div>
