...
- Name: User Management Flows >> cannot disable or delete last admin
- Location: C:\Users\apese\src\Sec\frontend\src\e2e\userManagement.spec.ts:47:7

# Error details

```
Error: expect.toBeDisabled: Error: strict mode violation: getByText('testuser@example.com').locator('..').locator('..').getByRole('button', { name: /disable/i }) resolved to 8 elements:
    1) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'testuser2@example.com Test' }).getByRole('button').first()
    2) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'regularuser@example.com' }).getByRole('button').first()
    3) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'nonadmin@example.com Non' }).getByRole('button').first()
    4) <button disabled type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'testuser@example.com Test' }).getByRole('button').first()
    5) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'lastadmin@example.com Last' }).getByRole('button').first()
    6) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'user3@example.com User Three' }).getByRole('button').first()
    7) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'user2@example.com User Two' }).getByRole('button').first()
    8) <button type="button" class="chakra-button css-852p9l">Disable</button> aka getByRole('row', { name: 'admin@example.com Admin User' }).getByRole('button').first()

Call log:
  - expect.toBeDisabled with timeout 5000ms
  - waiting for getByText('testuser@example.com').locator('..').locator('..').getByRole('button', { name: /disable/i })

    at C:\Users\apese\src\Sec\frontend\src\e2e\userManagement.spec.ts:53:30
```
