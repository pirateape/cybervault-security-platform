...
- Name: User Management Flows >> user cannot disable or delete self
- Location: C:\Users\apese\src\Sec\frontend\src\e2e\userManagement.spec.ts:38:7
...
Call log:
  ...
  - waiting for getByText('testuser@example.com').locator('..').locator('..').getByRole('button', { name: /disable/i })
    ...
    at C:\Users\apese\src\Sec\frontend\src\e2e\userManagement.spec.ts:43:30
```
